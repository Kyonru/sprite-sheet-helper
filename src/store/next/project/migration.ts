import { type ProjectSnapshot_v2, CURRENT_VERSION } from "@/types/project";
...
export function migrateSnapshot(raw: RawSnapshot): ProjectSnapshot_v2 {
  let current = raw;
  ...
  return current as unknown as ProjectSnapshot_v2;
}
